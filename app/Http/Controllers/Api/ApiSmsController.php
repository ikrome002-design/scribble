...
class ApiSmsController extends Controller
{
        ...
        switch ($action) {
            case 'send-sms':
                ...
                if (isset($results) && is_array($results) && count($results) <= 100) {
                    ...
                    if (strlen($sms) != strlen(mb_convert_encoding($sms, 'UTF-8', 'ISO-8859-1'))) {
            ...
            case 'check-balance':
                if (app_config('api_key') == $api_key) {
                    ...
                    $client = Client::where('api_key', $api_key)->where('api_access', 'Yes')->where('status', 'Active')->first();
    ...
    //======================================================================
    public function smsContactApi(Request $request)
    {
        $action       = $request->input('action');
        $api_key      = $request->input('api_key');
