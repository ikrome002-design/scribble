...
class DashboardController extends Controller
{
    ...
    {
        auth('admin')->logout();
        return redirect("//admin." . env('APP_DOMAIN'))->with([
    ...
    public function updateAvatar(Request $request)
    {
        ...
        if ($admin) {
            ...
            $image_name = basename(Storage::disk('private')->putFile('/profile/admin', $request->image));
            ...
            return back()->withErrors('The admin was not found');
        }
    }
    ...
    public function postUpdateApplication(Request $request)
    {
        ...
        $update_file   = $request->file('update_file');
