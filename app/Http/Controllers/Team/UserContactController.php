...
class UserContactController extends Controller
{
    ...
    {
        $clientGroups = ImportPhoneNumber::where('user_id', auth('team')->user()->cl_id)->orderBy('updated_at', 'DESC')->get();
    ...
    public function postPhoneBook(Request $request)
    {
        ...
        $exist = ImportPhoneNumber::where('group_name', $request->list_name)->where('user_id', auth('team')->user()->cl_id)->first();
        ...
        $phone_book->user_id = auth('team')->user()->cl_id;
    ...
    public function viewContact($id)
    {
        ...
        $exist = ImportPhoneNumber::where('user_id', auth('team')->user()->cl_id)->find($id);
    ...
    public function deleteContact($id)
    {
        ...
        if ($contact) {
            ...
            $exist = ImportPhoneNumber::where('user_id', auth('team')->user()->cl_id)->find($contact->pid);
    ...
    public function deleteImportPhoneNumber($id)
    {
        ...
        $clientGroup = ImportPhoneNumber::where('user_id', auth('team')->user()->cl_id)->find($id);
    ...
    public function getAllContact($id)
    {
        ...
        return Datatables::of($contact_list)
            ->addColumn('action', function ($cl) {
                ...
                <a class="btn btn-success btn-xs" href="' . url("user/edit-contact/$cl->id") . '" ><i class="fa fa-edit"></i>Edit</a>
                <a href="#" class="btn btn-danger btn-xs cdelete" id="' . $cl->id . '"><i class="fa fa-trash"></i> Delete</a>';
            })
