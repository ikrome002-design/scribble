...
class VisitorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $sms = new SmsHelper();
        $sms->sendProSms(prosub: $bus->proSubscription, client: $client, phone: $request->phone_number, message: $message, minutes: 10);
    ...
    public function checkOutVisitor(Request $request, $id)
    {
        ...
        $sms = new SmsHelper();
        $sms->sendProSms(prosub: $bus->proSubscription, client: $client, phone: $visitor->phone_number, message: $message, minutes: 10);
