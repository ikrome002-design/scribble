...
class PaymentController extends Controller
{
    ...
    public function payInvoice(Request $request)
    {
        ...
        $gateway_id = $request->get('gateway');
        ...
        if ($gateway == 'paypal') {
            ...
            $redirect_urls->setReturnUrl(url('/user/invoice/success/' . $token . '/' . $cmd))
                /** Specify return URL **/
...
?>
    ...
    public function purchaseSMSPlanPost(Request $request)
    {
        ...
        if ($gateway == 'paypal') {
            ...
            $redirect_urls = new RedirectUrls();
            $redirect_urls->setReturnUrl(url('/user/sms/purchase-plan/success/' . $token . '/' . $cmd))
                /** Specify return URL **/
    ...
    public function postBuyUnit(Request $request)
    {
        ...
        if ($gateway == 'paypal') {
            ...
            $redirect_urls = new RedirectUrls();
            $redirect_urls->setReturnUrl(url('/user/sms/buy-unit/success/' . $token . '/' . $number_unit))
                /** Specify return URL **/
    ...
    public function postPurchaseKeyword(Request $request)
    {
        ...
        if ($gateway == 'paypal') {
            ...
            $redirect_urls = new RedirectUrls();
            $redirect_urls->setReturnUrl(url('/user/keywords/buy-keyword/success/' . $token . '/' . $keyword_id))
                /** Specify return URL **/
