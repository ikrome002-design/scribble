...
class UserSMSController extends Controller
{
    ...
    public function postSenderID(Request $request)
    {
        ...
        try {
            \Mail::to(app_config('Email'))->send(new RequestSenderID(Auth::guard('client')->user()->fname, $client->email, $request->sender_id, $url, $files_email));
    ...
    public function PurchaseAirtimeBundle()
    {
        ...
        $client = Client::where('id', Auth::guard('client')->user()->id)
    ...
    public function artimeBundleCalc(Request $request, $id)
    {
        ...
        $calc = $calc->calculatePrice(
            $airtime->price,
            $airtime->govt_charges_type,
            $airtime->govt_charges_amt,
            $airtime->discount_amount,
            $airtime->discount_type,
            $airtime->transaction_fee,
            $units
        );
    ...
    public function smsPricePlanCalc(Request $request)
    {
        ...
        $calc = $calc->calculatePrice(
            $smsPlan->price,
            $smsPlan->govt_charges_type,
            $smsPlan->govt_charges_amt,
            $smsPlan->discount_amount,
            $smsPlan->discount_type,
            $smsPlan->transaction_fee,
            $units
        );
