...
class SubscriptionController extends Controller
{
    ...
    {
        $subs = TeamSubscription::where('cl_id', auth('client')->user()->id)->get();
    ...
    public function create()
    {
        ...
        $teamplan = TeamPlan::where('plan_id', auth('client')->user()->plan_id)
        ...
        $expiryDate = Carbon::parse(auth('client')->user()->plan_recurring_date)->endOfDay();
