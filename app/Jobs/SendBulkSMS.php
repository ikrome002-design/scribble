...
class SendBulkSMS implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        } elseif ($this->gateway->type == 'smpp' && $this->gateway->custom_smpp == 'No') {
            Log::info($gateway_name);
        ...
        \r\n </destinations>\r\n <message>$message</message>\r\n
                ...
                case 'Ejoin':
                    ...
                    if (curl_error($ch)) {
                        ...
                        if (
                            isset($get_response) && is_array($get_response) && array_key_exists('code', $get_response) &&
                            array_key_exists('reason', $get_response)
                        ) {
                ...
                case 'OpenVox':
                    $clphone = str_replace([" ", '+'], "", $this->cl_phone);
                    $sms_sent_to_user = $gateway_url . "/sendsms?username=$gateway_user_name" . "&password=$gateway_password" .
                        "&phonenumber=$clphone" . "&message=" . urlencode($this->message);
                ...
                case 'Smsgatewayhub':
                    $clphone = str_replace([" ", '+'], "", $this->cl_phone);
                    $sms_sent_to_user = $gateway_url . "?APIKey=$gateway_user_name" . "&senderid=$this->sender_id" .
                        "&channel=$gateway_password" . "&number=$clphone" . "&flashsms=0&text=" . urlencode($this->message) . "&route=" .
                        $gateway_extra;
                ...
                case 'transfer.sh':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = "$sms_url" . "?username=$gateway_user_name" . "&password=$gateway_password" .
                            "&mobile=$this->cl_phone" . "&sender=$sender_id" . "&message=$message" . "&language=$type";
                ...
                case 'Tellegroup':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = "$sms_url" . "?&dispatch=send&account=$gateway_user_name" . "&code=$gateway_password" .
                            "&to=$client_phone" . "&msg=$message" . "&id=$unique_id" . "&tipoEnvio=2" . "&type=E";
                        ...
                        switch ($get_response) {
                            ...
                            case '150':
                                $get_sms_status = 'Mensagem expirou na operadora. Celular pode estar desligado, fora da área de cobertura ou
indisponível no sistema';
                ...
                case 'MaskSMS':
                    ...
                    try {
                        $sms_sent_to_user = "$sms_url" . "?action=send-sms&api_key=$gateway_user_name" . "&from=$sender_id" .
                            "&to=$this->cl_phone" . "&sms=$message";
                ...
                case 'AdvanceMessage':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = "$sms_url" . "/websms?user=$gateway_user_name" . "&pass=$gateway_password" . "&sid=$sender_id" .
                            "&mno=$this->cl_phone" . "&type=$type" . "&text=$message";
                ...
                case 'BudgetSMS':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?username=$gateway_user_name" . "&userid=$gateway_password" . "&to=$clphone" .
                            "&msg=$message" . "&handle=$gateway_extra" . "&from=$this->sender_id";
                ...
                case 'CoinSMS':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?username=$gateway_user_name" . "&password=$gateway_password" .
                            "&recipient=$clphone" . "&message=$message" . "&sender=$this->sender_id";
    ...
    \"sender\": \"$this->sender_id\" \n }");
                ...
                case 'GlobalSMS':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?key=$gateway_user_name" . "&contacts=$clphone" . "&msg=$message" .
                            "&senderid=$this->sender_id" . "&type=$sms_type";
                ...
                case 'LRTelecom':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?username=$gateway_user_name" . "&password=$gateway_password" .
                            "&phone=$clphone" . "&message=$message" . "&sender=$sender_id" . "&type=$sms_type";
                ...
                case 'Montnets':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?userid=$gateway_user_name" . "&pwd=$gateway_password" . "&mobile=$client_phone"
                            . "&content=$message";
                ...
                case 'CARMOVOIPSHORT':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?cpf=$gateway_user_name" . "&password=$gateway_password" .
                            "&numbers=$client_phone" . "&messages=$message&type=short";
                ...
                case 'CARMOVOIPLONG':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?cpf=$gateway_user_name" . "&password=$gateway_password" .
                            "&numbers=$client_phone" . "&messages=$message&type=long";
                ...
                case 'ShotBulkSMS':
                    ...
                    $sms_sent_to_user = $gateway_url . "?user=$gateway_user_name" . "&password=$gateway_password" .
                        "&PhoneNumber=$clphone" . "&Sender=$this->sender_id";
                ...
                case 'OnnorokomSMS':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $sms_url . "?op=OneToOne&type=$sms_type" . "&username=$gateway_user_name" .
                            "&password=$gateway_password" . "&mobile=$this->cl_phone" . "&smsText=$message" . "&campaignName=";
                ...
                case 'Send99':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $sms_url . "?api_id=$gateway_user_name" . "&api_password=$gateway_password" .
                            "&phonenumber=$this->cl_phone" . "&sender_id=$sender_id" . "&textmessage=$message" . "&sms_type=$sms_type" .
                            "&encoding=$encoding";
                ...
                case 'PreciseSMS':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?apikey=$gateway_user_name" . "&recipients=$phone" .
                            "&sender=$this->sender_id" . "&smstext=$message" . "&apiType=json";
                ...
                case 'Otency':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $sms_url . "?username=$gateway_user_name" . "&password=$gateway_password" .
                            "&recipient=$this->cl_phone" . "&sender=$sender_id" . "&message=$message";
                ...
                case 'MrMessaging':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?username=$gateway_user_name" . "&password=$gateway_password" .
                            "&receiver=$clphone" . "&message=$message" . "&sender=$sender_id" . "&coding=$coding";
                ...
                case 'PenSMS':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?sendsms&apikey=$gateway_user_name" . "&apitoken=$gateway_password" .
                            "&from=$sender_id" . "&to=$clphone" . "&text=$message" . "&type=$msg_type";
                ...
                case 'SignalWire':
                    ...
                    if (
                        isset($result) && is_array($result) && array_key_exists('status', $result) &&
                        array_key_exists('error_code', $result)
                    ) {
                ...
                case 'Telnyx':
                    ...
                    try {
                        ...
                        if (isset($get_response) && is_array($get_response)) {
                            if (
                                array_key_exists('data', $get_response) && isset($get_response['data']['to'][0]['status']) &&
                                $get_response['data']['to'][0]['status'] == 'queued'
                            ) {
                                $get_sms_status = 'Success';
                ...
                case 'Digimiles':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = "$sms_url" . "/bulksms/bulksms?type=$type" . "&username=$gateway_user_name" .
                            "&password=$gateway_password" . "&destination=$this->cl_phone" . "&source=$sender_id" . "&message=$message"
                            . "&dlr=0";
                ...
                case 'FortyTwo':
                    ...
                    if ($err) {
                        ...
                        if (isset($response) && is_array($response) && array_key_exists('result_info', $response)) {
                            if (
                                is_array($response['result_info']) && array_key_exists('status_code', $response['result_info']) &&
                                array_key_exists('description', $response['result_info'])
                            ) {
            ...
            <sms />');
                    ...
                    try {
                        ...
                        if (is_array($get_data) && array_key_exists('outboundSMSMessageRequest', $get_data)) {
                            if (isset($get_data['outboundSMSMessageRequest']['deliveryInfoList']['deliveryInfo']['0']['deliveryStatus'])) {
                                if (
                                    $get_data['outboundSMSMessageRequest']['deliveryInfoList']['deliveryInfo']['0']['deliveryStatus'] ==
                                    'MessageWaiting' ||
                                    $get_data['outboundSMSMessageRequest']['deliveryInfoList']['deliveryInfo']['0']['deliveryStatus'] ==
                                    'DeliveredToNetwork'
                                ) {
                ...
                case 'GoIP':
                    ...
                    try {
                        $get_sms_status = file_get_contents(
                            $gateway_url .
                                "/default/en_US/send.html?u=$gateway_user_name&p=$gateway_password&l=1&n=$this->cl_phone&m=$message",
                            false,
                            $context
                        );
                ...
                <Originator>$this->sender_id</Originator>
                <SDate></SDate>
            </MainmsgBody>";
                ...
                case 'AfricasTalking':
                    ...
                    try {
                        ...
                        if (
                            isset($get_data) && is_array($get_data) && array_key_exists('data', $get_data) &&
                            array_key_exists('status', $get_data) && isset($get_data['data']->SMSMessageData)
                        ) {
                        ...
                        $get_sms_status = 'mmm' . $e->getMessage();
                    }
                ...
                case 'Apifon':
                    ...
                    try {
                        ...
                        switch ($http_code) {
                            ...
                            case '401':
                                $get_sms_status = 'Unauthorized – Header “Authorization” missing, invalid, or revoked; and / or, your host
            IP is not in the authorized IPs list.';
                                break;
                            ...
                            case '404':
                                $get_sms_status = 'Not Found – The endpoint on which the request was sent to, does not exist, or does not
            implement the API requested.';
                                break;

                            case '405':
                                $get_sms_status = 'Method Not Allowed – If the endpoint received a request using an HTTP method (ex. GET
            instead of POST) that is not allowed by that endpoint.';
                                break;

                            case '415':
                                $get_sms_status = 'Unsupported Media Type – If the request was in a content-type not supported by the
            endpoint (ex. text/plain instead of application/json).';
                                break;
                ...
                case 'TwizoCom':
                    ...
                    try {
                        ...
                        if ($http_code == 200 || $http_code == 201) {
                            if (
                                isset($get_data['_embedded']['items']['0']['statusCode']) &&
                                $get_data['_embedded']['items']['0']['statusCode'] == 0
                            ) {
                                $get_sms_status = 'Success';
                            } else {
                ...
                case 'iBulky':
                    ...
                    $gateway_url = $gateway_url . "?username=" . $gateway_user_name . "&password=" . $gateway_password .
                        "&recipient=" . $this->cl_phone . "&sender=" . $this->sender_id . "&message=" . $message . "&msgtype=text";
                    ...
                    if (strpos($get_sms_status, 'SENT') !== false) {
                        ...
                        switch ($get_sms_status) {
                            ...
                            case '2502':
                                $get_sms_status = 'Invalid URL Error, This means that one of the required parameters was not provided or
            left blank';
                                break;
            ...
            <SMS />');
                ...
                case 'GreenSMSTop':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = "$sms_url" . "?type=$type" . "&username=$gateway_user_name" .
                            "&password=$gateway_password" . "&destination=$this->cl_phone" . "&source=$sender_id" . "&message=$message"
                            . "&dlr=0";
                ...
                case 'Telenor':
                    ...
                    $auth_url =
                        "https://telenorcsms.com.pk:27677/corporate_sms2/api/auth.jsp?msisdn=$gateway_user_name&password=$gateway_password";
                ...
                case 'Interaktif':
                    ...
                    if (strpos($response, '00') !== false) {
                        ...
                        $get_sms_status = 'Mesaj metni ve numaralar incelendikten sonra sistem yollanacak bir SMS
                    oluşturmaya yetecek en az 1 numara ve en az 1 karakterden oluşan mesaj metnine sahip olamadı.
                    Gönderim yapılacak verilerin yeterli olmadığına karar verdi.';
                    } elseif ($response == '81') {
                ...
                case 'EpsinsmsIn':
                    ...
                    $url =
                        "$gateway_url?AUTH_KEY=$gateway_user_name&message=$message&senderId=$this->sender_id&routeId=$gateway_password&mobileNos=$this->cl_phone";
                ...
                case 'SpeedsmsVN':
                    ...
                    $json = json_encode(array(
                        'to' => $this->cl_phone, 'content' => $this->message, 'sms_type' => $type,
                        'sender' => $sender_id
                    ));
                    ...
                    if (curl_error($ch)) {
                        ...
                        if (isset($get_sms_status) && is_array($get_sms_status) && array_key_exists(
                            'status',
                            $get_sms_status
                        )) {
                ...
                case 'sms77IO':
                    ...
                    switch ($get_sms_status) {
                        ...
                        case '201':
                            $get_sms_status = 'Sender invalid. A maximum of 11 alphanumeric or 16 numeric characters are
                    allowed';
                            break;
                ...
                case 'Tobeprecisesms':
                    ...
                    $base_url = $gateway_url . '/api/sendsms/singleSMS?username=' . $gateway_user_name . '&Password=' .
                        $gateway_password;
                ...
                case 'RawMobility':
                    ...
                    try {
                        ...
                        if (curl_errno($ch)) {
                            ...
                            if (
                                isset($output) && is_array($output) && array_key_exists('detailedResponse', $output) &&
                                array_key_exists('routeId', $output)
                            ) {
                    ...
                    if ($curl_error) {
                        ...
                        if ($response && is_array($response)) {
                            ...
                            if ((array_key_exists('code', $response) && array_key_exists('message', $response) &&
                                $response['code'] == 200) || array_key_exists('guid', $response)) {
                                $get_sms_status = 'Success';
                            } else {
                                $get_sms_status = $response['message'];
                            }
                ...
                case '360nrs':
                    ...
                    try {
                        ...
                        if (isset($result) && is_array($result)) {
                            if (array_key_exists('result', $result) && is_array($result['result']) && array_key_exists(
                                '0',
                                $result['result']
                            )) {
                                ...
                                array_key_exists('error', $result) && is_array($result['error']) &&
                                array_key_exists('description', $result['error'])
                            ) {
                ...
                case 'PineAppleSMS':
                    ...
                    try {
                        ...
                        $sms_sent_to_user = $gateway_url . "?username=$gateway_user_name" . "&password=$gateway_password" .
                            "&dnis=$this->cl_phone" . "&ani=$sender_id" . "&message=$message" .
                            "&command=submit&longMessageMode=cut";
        ...
        $check = SMSHistory::where('sender', $sender_id)->where('receiver', $receiver)->where(
            'send_by',
            'receiver'
        )->where('userid', $this->user_id)->first();
            ...
            if ($this->gateway->settings != 'InfoBip') {
                if (substr_count(strtolower($get_sms_status), 'success') == 0) {
                    ...
                    if ($sms_cost) {
                        ...
                        $get_operator = Operator::where('operator_setting', $operator_settings)->where(
                            'coverage_id',
                            $sms_cost->id
                        )->first();
