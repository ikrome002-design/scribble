                        ...
                        <div class="panel-body p-none">
                            <form action="" method="post">
                                <p class="text-primary fs-5">
                                    ...
                                    *Those given role to edit or delete , will automaticlaly have check out role<br>
                                    *Please if you check re assign role , ensure that the staff has a role to view staff
                                    in that
