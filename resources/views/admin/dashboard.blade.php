                            ...
                            <div class="z-shad-1">
                                <div class="bg-success text-white p-15 clearfix">
                                    ...
                                    <div class="pull-right text-right m-t-15">
                                        <span class="small m-b-5 font-15">{{ $total_clients }}
                                            {{ language_data('Client') }}(s)</span>
                                        <br>
                                        <a href="{{ url('clients/add') }}"
                                            class="btn btn-complete btn-xs text-uppercase">{{ language_data('Add New') }}</a>
                                    </div>
                        ...
                        <div class="col-sm-3 m-b-15">
                            <div class="z-shad-1">
                                <div class="bg-primary text-white p-15 clearfix">
                                    ...
                                    <div class="pull-right text-right m-t-15">
                                        <span class="small m-b-5 font-15">{{ $total_groups }}
                                            {{ language_data('Client Group') }}(s)</span>
                                        <br>
                                        <a href="{{ url('clients/groups') }}"
                                            class="btn btn-complete btn-xs text-uppercase">{{ language_data('Add New') }}</a>
                                    </div>
                        ...
                        <div class="col-sm-3 m-b-15">
                            <div class="z-shad-1">
                                <div class="bg-warning text-white p-15 clearfix">
                                    ...
                                    <div class="pull-right text-right m-t-15">
                                        <span class="small m-b-5 font-15">{{ $total_invoice }}
                        ...
                        <div class="col-sm-3 m-b-15">
                            <div class="z-shad-1">
                                <div class="bg-danger text-white p-15 clearfix">
                                    ...
                                    <div class="pull-right text-right m-t-15">
                                        <span class="small m-b-5 font-15">{{ $total_tickets }}
                                            {{ language_data('Tickets') }}</span>
                                        <br>
                                        <a href="{{ url('support-tickets/create-new') }}"
                                            class="btn btn-complete btn-xs text-uppercase">{{ language_data('Add New') }}</a>
                                    </div>
                                            ...
                                            @foreach ($recent_five_invoices as $inv)
                                                <tr>
                                                    <td data-label="{{ language_data('Client') }}">
                                                        <p><a href="{{ url('clients/view/' . $inv->cl_id) }}">

                                                                {{ $inv->client->fname }} {{ $inv->client->lname }}
                                                            </a>
                                                        </p>
                                                    </td>
                                                    <td data-label="{{ language_data('Amount') }}">
                                                        <p><a
                                                                href="{{ url('invoices/view/' . $inv->id) }}">{{ us_money_format($inv->total) }}</a>
                                                        </p>
                                                    </td>
                                            ...
                                            @foreach ($recent_five_tickets as $rtic)
                                                <tr>
                                                    <td data-label="{{ language_data('Email') }}">
                                                        <p><a href="{{ url('clients/view/' . $rtic->cl_id) }}">
                                                                {{ $rtic->email }}</a></p>
                                                    </td>
                                                    <td data-label="{{ language_data('Subject') }}">
                                                        <p><a
                                                                href="{{ url('support-tickets/view-ticket/' . $rtic->id) }}">{{ $rtic->subject }}</a>
                                                        </p>
                                                    </td>
