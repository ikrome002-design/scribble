            ...
            <div class="row">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form class="" role="form" method="post" action="{{ url('clients/post-new-client') }}"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Plan Status (leave Inactive if you want send invoice for user pay.)</label>
                                ...
                                <div class="form-group">
                                    <label>{{ language_data('SMS Limit') }} <small></small></label>
                                    <input type="text" class="form-control" value="0" name="sms_limit"
                                        value="{{ old('sms_limit') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" checked value="Yes" name="create_invoice">
                                        <span class="co-check-ui"></span>
                            ...
                            <button type="submit" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i>
