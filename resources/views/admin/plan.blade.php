...
@section('content')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">{{language_data('Plans')}}</h2>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        ...
                        <a class="btn btn-success btn-xs" style="margin-bottom : 6px; margin-left : 6px;" href="{{ url('sms/add-plan-name') }}" ><i class="fa fa-plus"></i> {{language_data('ADD PLAN')}}</a>
                                    ...
                                    @foreach($plan as $pp)
                                        <tr>
                                            ...
                                            <td data-label="Actions">
                                                <a  class="btn btn-danger btn-xs cdelete" id="{{$pp->id}}" href="{{url('sms/delete-plan/'.$pp->id) }}"> <i class="fa fa-trash"></i> {{language_data('Delete')}}</a>
                                            </td>
                                        </tr>
                                    @endforeach
          ...
          $('.data-table').DataTable({
            ...
            $( "body" ).delegate( ".cdelete", "click",function (e) {
              ...
              bootbox.confirm("{!! language_data('Are you sure') !!}?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/sms/delete-plan/" + id;
                    }
                });
            });
