                            ...
                            <div class="col-lg-3">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        @if (
                                            $gateway->settings != 'Twilio' &&
                                                $gateway->settings != 'Zang' &&
                                                $gateway->settings != 'Plivo' &&
                                                $gateway->settings != 'PlivoPowerpack' &&
                                                $gateway->settings != 'AmazonSNS' &&
                                                $gateway->settings != 'TeleSign' &&
                                                $gateway->settings != 'TwilioCopilot' &&
                                                $gateway->settings != 'Ovh' &&
                                                $gateway->settings != 'Sendpulse')
                                            <div class="form-group">
                                                <label>{{ language_data('Gateway API Link') }}</label>
                                                <input type="text" class="form-control" required name="gateway_link"
                                                    value="{{ $gateway->api_link }}">
                                            </div>
                                        @endif

                                        @if (
                                            $gateway->settings == 'Asterisk' ||
                                                $gateway->settings == 'JasminSMS' ||
                                                $gateway->settings == 'Diafaan' ||
                                                $gateway->settings == 'Ovh' ||
                                                $gateway->type == 'smpp' ||
                                                $gateway->settings == 'Send99' ||
                                                $gateway->settings == 'Mobitel')
                                            <div class="form-group">
                                                ...
                                                @elseif($gateway->settings == 'Send99' || $gateway->settings == 'Mobitel')
                                                    ...
                                                    <select class="selectpicker form-control" name="port">
                                                        <option value="promotional"
                                                            @if ($gateway->port == 'promotional') selected @endif>Promotional
                                                        </option>
                                                        <option value="transactional"
                                                            @if ($gateway->port == 'transactional') selected @endif>Transactional
                                                        </option>
                                                    </select>
                                                @else
                                                    <label>Port</label>
                                        ...
                                        @if ($gateway->type == 'smpp')
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker form-control" name="two_way">
                                                    <option value="Yes"
                                                        @if ($gateway->two_way == 'Yes') selected @endif>
                                                        {{ language_data('Yes') }}</option>
                                                    <option value="No"
                                                        @if ($gateway->two_way == 'No') selected @endif>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="schedule">
                                                <option value="Yes" @if ($gateway->schedule == 'Yes') selected @endif>
                                                    {{ language_data('Yes') }}</option>
                                                <option value="No" @if ($gateway->schedule == 'No') selected @endif>
                                                    {{ language_data('No') }}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="global_status">
                                                <option value="Active" @if ($gateway->status == 'Active') selected @endif>
                                                    {{ language_data('Active') }}</option>
                                                <option value="Inactive" @if ($gateway->status == 'Inactive') selected @endif>
                                                    {{ language_data('Inactive') }}</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label> Custom Smpp</label>
                                            <select class="selectpicker form-control" name="custom_smpp">
                                                <option value="No">No</option>
                                                <option @selected($gateway->custom_smpp == 'Yes') value="Yes">Yes</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <tbody>
                                                @foreach ($credentials as $credential)
                                                    <tr class="info">
                                                            ...
                                                            <div class="form-group">
                                                                <label>
                                                                    ...
                                                                    @elseif(
                                                                        $gateway->settings == 'Twilio' ||
                                                                            $gateway->settings == 'Zang' ||
                                                                            $gateway->settings == 'XOXZO' ||
                                                                            $gateway->settings == 'Ytel' ||
                                                                            $gateway->settings == 'ApiFonica')
                                                                    ...
                                                                    @elseif($gateway->settings == 'MessageBird' || $gateway->settings == 'AmazonSNS' || $gateway->settings == 'FlowRoute')
                                                                        Access Key
                                                                    @elseif(
                                                                        $gateway->settings == 'Clickatell_Touch' ||
                                                                            $gateway->settings == 'ViralThrob' ||
                                                                            $gateway->settings == 'CNIDCOM' ||
                                                                            $gateway->settings == 'SmsBump' ||
                                                                            $gateway->settings == 'BSG' ||
                                                                            $gateway->settings == 'Onehop' ||
                                                                            $gateway->settings == 'TigoBeekun' ||
                                                                            $gateway->settings == 'Beepsend' ||
                                                                            $gateway->settings == 'Easy' ||
                                                                            $gateway->settings == 'Mailjet' ||
                                                                            $gateway->settings == 'Smsgatewayhub' ||
                                                                            $gateway->settings == 'MaskSMS' ||
                                                                            $gateway->settings == 'EblogUs' ||
                                                                            $gateway->settings == 'MessageWhiz' ||
                                                                            $gateway->settings == 'GlobalSMS' ||
                                                                            $gateway->settings == 'ElasticEmail' ||
                                                                            $gateway->settings == 'Nexmo' ||
                                                                            $gateway->settings == 'PreciseSMS' ||
                                                                            $gateway->settings == 'Text Local' ||
                                                                            $gateway->settings == 'SMSKitNet' ||
                                                                            $gateway->settings == 'PenSMS' ||
                                                                            $gateway->settings == 'Clockworksms' ||
                                                                            $gateway->settings == 'Mocean' ||
                                                                            $gateway->settings == 'Telnyx' ||
                                                                            $gateway->settings == 'Bics' ||
                                                                            $gateway->settings == 'APIWHA' ||
                                                                            $gateway->settings == 'SMSAPIOnline' ||
                                                                            $gateway->settings == 'ImapServiceOnline' ||
                                                                            $gateway->settings == 'FairPlayerSMS' ||
                                                                            $gateway->settings == 'WhereWeChat' ||
                                                                            $gateway->settings == 'SinchPortal' ||
                                                                            $gateway->settings == 'KSMSUS' ||
                                                                            $gateway->settings == 'SMSTO' ||
                                                                            $gateway->settings == 'TwizoCom' ||
                                                                            $gateway->settings == 'Releans' ||
                                                                            $gateway->settings == 'DidForSale' ||
                                                                            $gateway->settings == 'SMSEdgeIO' ||
                                                                            $gateway->settings == 'sms77IO' ||
                                                                            $gateway->settings == 'SilverStreet' ||
                                                                            $gateway->settings == 'AdnSMS' ||
                                                                            $gateway->settings == 'Voyant' ||
                                                                            $gateway->settings == 'SMS123' ||
                                                                            $gateway->settings == 'EngageSpark' ||
                                                                            $gateway->settings == 'MoviderCo' ||
                                                                            $gateway->settings == 'TheTexting' ||
                                                                            $gateway->settings == 'VoxoloGy' ||
                                                                            $gateway->settings == 'SmartBuyEstoreComAu' ||
                                                                            $gateway->settings == 'SMSiPanel' ||
                                                                            $gateway->settings == 'TextBelt')
                                                                        API Key
                                                                    ...
                                                                    @elseif(
                                                                        $gateway->settings == 'LightSMS' ||
                                                                            $gateway->name == 'KingTelecom' ||
                                                                            $gateway->name == 'Tellegroup' ||
                                                                            $gateway->name == 'BrilliantComBD')
                                                                        Login
                                                                    ...
                                                                    @elseif($gateway->settings == 'CMSMS')
                                                                        Product Token
                                                                    @elseif(
                                                                        $gateway->settings == 'ClxnetworksHTTPRest' ||
                                                                            $gateway->settings == 'SmsGatewayMe' ||
                                                                            $gateway->settings == 'WhatsAppChatApi' ||
                                                                            $gateway->settings == 'Gatewayapi' ||
                                                                            $gateway->settings == 'Bandwidth' ||
                                                                            $gateway->settings == 'Envialosimplesms' ||
                                                                            $gateway->settings == 'SlingComNg' ||
                                                                            $gateway->settings == 'Wablas' ||
                                                                            $gateway->settings == 'Waboxapp' ||
                                                                            $gateway->settings == 'SmsGateWay24')
                                                                        API Token
                                                                    ...
                                                                    @elseif($gateway->settings == 'BulkGate' || $gateway->settings == 'RouteeNet')
                                                                        Application ID
                                                                    @elseif(
                                                                        $gateway->settings == 'msg91' ||
                                                                            $gateway->settings == 'Freekasms' ||
                                                                            $gateway->settings == 'MsgOnDND' ||
                                                                            $gateway->settings == 'EpsinsmsIn')
                                                                        Auth Key
                                                        ...
                                                        @if (
                                                            $gateway->settings != 'MessageBird' &&
                                                                $gateway->settings != 'SmsGatewayMe' &&
                                                                $gateway->settings != 'Clickatell_Touch' &&
                                                                $gateway->settings != 'Tropo' &&
                                                                $gateway->settings != 'SmsBump' &&
                                                                $gateway->settings != 'BSG' &&
                                                                $gateway->settings != 'Beepsend' &&
                                                                $gateway->settings != 'TigoBeekun' &&
                                                                $gateway->settings != 'Easy' &&
                                                                $gateway->settings != 'CMSMS' &&
                                                                $gateway->settings != 'Mailjet' &&
                                                                $gateway->settings != 'ClxnetworksHTTPRest' &&
                                                                $gateway->settings != 'MaskSMS' &&
                                                                $gateway->settings != 'WhatsAppChatApi' &&
                                                                ...
                                                                $gateway->settings != 'SMSTO' &&
                                                                $gateway->settings != 'TwizoCom' &&
                                                                $gateway->settings != 'TeleAPI' &&
                                                                $gateway->settings != 'Releans' &&
                                                                $gateway->settings != 'SpeedsmsVN' &&
                                                                $gateway->settings != 'sms77IO' &&
                                                                $gateway->settings != 'SilverStreet' &&
                                                                $gateway->settings != 'FortyTwo' &&
                                                                $gateway->settings != 'Envialosimplesms' &&
                                                                $gateway->settings != 'SlingComNg' &&
                                                                $gateway->settings != 'Voyant' &&
                                                                $gateway->settings != 'SMS123' &&
                                                                $gateway->settings != 'BroadcasterSMS' &&
                                                                $gateway->settings != 'VoxoloGy' &&
                                                                $gateway->settings != 'Wablas' &&
                                                                $gateway->settings != 'Waboxapp' &&
                                                                $gateway->settings != 'SMSiPanel' &&
                                                                    ...
                                                                    <label>
                                                                        @if (
                                                                            $gateway->settings == 'Twilio' ||
                                                                                ...
                                                                                $gateway->settings == 'Plivo' ||
                                                                                $gateway->settings == 'PlivoPowerpack' ||
                                                                                $gateway->settings == 'KarixIO' ||
                                                                                $gateway->settings == 'XOXZO' ||
                                                                                $gateway->settings == 'MovileCom' ||
                                                                                $gateway->settings == 'Ytel' ||
                                                                                $gateway->settings == 'ApiFonica' ||
                                                                                $gateway->settings == 'VoxCpaas')
                                                                            {{ language_data('Auth Token') }}
                                                                        @elseif(
                                                                            $gateway->settings == 'SMSKaufen' ||
                                                                                $gateway->settings == 'NibsSMS' ||
                                                                                $gateway->settings == 'LightSMS' ||
                                                                                $gateway->settings == 'Wavecell' ||
                                                                                $gateway->settings == 'ClickSend' ||
                                                                                $gateway->settings == 'IntelTele' ||
                                                                                $gateway->settings == 'SMSHubsNet' ||
                                                                                $gateway->settings == 'AfricasTalking' ||
                                                                                $gateway->settings == 'Bulkness' ||
                                                                                $gateway->settings == 'PhilmoreSMS')
                                                                            {{ language_data('SMS Api key') }}
                                                                        @elseif(
                                                                            $gateway->settings == 'Semysms' ||
                                                                                $gateway->settings == 'SmsGateWay24' ||
                                                                                $gateway->settings == 'SmartBuyEstoreComAu')
                                                                            Device ID
                                                                        @elseif(
                                                                            $gateway->name == 'Skebby' ||
                                                                                $gateway->name == 'KingTelecom' ||
                                                                                $gateway->name == 'LinkMobility' ||
                                                                                $gateway->name == 'DidForSale')
                                                                            Access Token
                                                                        @elseif(
                                                                            $gateway->settings == 'SendOut' ||
                                                                                $gateway->settings == 'SMSKitNet' ||
                                                                                $gateway->settings == 'PenSMS' ||
                                                                                $gateway->settings == 'SignalWire' ||
                                                                                $gateway->settings == 'Trumpia' ||
                                                                                $gateway->settings == 'Apifon' ||
                                                                                $gateway->settings == 'ComAPI' ||
                                                                                $gateway->settings == 'Thinq')
                                                                            API Token
                                                        ...
                                                        @if (
                                                            $gateway->custom == 'Yes' ||
                                                                $gateway->settings == 'SmsGatewayMe' ||
                                                                $gateway->settings == 'GlobexCam' ||
                                                                $gateway->settings == 'Ovh' ||
                                                                $gateway->settings == 'SMSPRO' ||
                                                                $gateway->settings == 'DigitalReach' ||
                                                                $gateway->settings == 'AmazonSNS' ||
                                                                $gateway->settings == 'ExpertTexting' ||
                                                                $gateway->settings == 'Advansystelecom' ||
                                                                $gateway->settings == 'AlertSMS' ||
                                                                $gateway->settings == 'Clickatell_Central' ||
                                                                $gateway->settings == 'Smsgatewayhub' ||
                                                                $gateway->settings == 'Ayyildiz' ||
                                                                $gateway->settings == 'TwilioCopilot' ||
                                                                $gateway->settings == 'BudgetSMS' ||
                                                                $gateway->settings == 'msg91' ||
                                                                $gateway->settings == 'Freekasms' ||
                                                                $gateway->settings == 'FortyTwo' ||
                                                                $gateway->settings == 'TheSMSWorks' ||
                                                                $gateway->settings == 'ZamtelCoZm' ||
                                                                $gateway->settings == 'Bandwidth' ||
                                                                $gateway->settings == 'Safaricom' ||
                                                                $gateway->settings == 'TigoBusiness' ||
                                                                $gateway->settings == 'RawMobility' ||
                                                                $gateway->settings == 'Thinq' ||
                                                                $gateway->settings == 'SMSLive247' ||
                                                                $gateway->settings == 'SmsGateWay24')
                                                            <td>
                                                        ...
                                                        @if ($gateway->settings == 'Asterisk')
                                                            <td>
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="device_name" value="{{ env('SC_DEVICE') }}">
                                                                </div>
                                                            </td>
                                                        @endif
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="selectpicker form-control"
                                                                    name="credential_base_status[]">
                                                                    <option value="Active"
                                                                        @if ($credential->status == 'Active') selected @endif>
                                                                        {{ language_data('Active') }}</option>
                                                                    <option value="Inactive"
                                                                        @if ($credential->status == 'Inactive') selected @endif>
                                                                        {{ language_data('Inactive') }}</option>
                                                                </select>
                                                                <span
                                                                    class="help">{{ language_data('You can only active one credential information') }}</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                        ...
                                        <div class="text-right">
                                            ...
                                            <button type="submit" class="btn btn-success btn-sm pull-right"><i
                                                    class="fa fa-save"></i> {{ language_data('Update') }} </button>
                                        </div>
                                    </div>
                                </div>
