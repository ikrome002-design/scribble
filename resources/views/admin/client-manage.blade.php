...
@section('content')
                            ...
                            <div class="clearfix">
                                <div class="pull-left m-r-30">
                                    <div class="thumbnail m-b-none">
                                        <img src="/private/profile/client/{{ $client->id }}/{{ $client->image }}"
                                            alt="{{ $client->fname }} {{ $client->lname }}" height="150px" width="150px">
                                    </div>
                                </div>
                                <div class="pull-left">
                                    ...
                                    <ul class="info-list">
                                        @if ($client->email != '')
                                            <li>
                                                <span class="info-list-title">{{ language_data('Email') }}</span><span
                                                    class="info-list-des">{{ $client->email }}</span>
                                            </li>
                                        @endif
                                        <li>
                                            <span class="info-list-title">{{ language_data('Phone') }}</span><span
                                                class="info-list-des">{{ $client->phone }}</span>
                                        </li>
                                        <li>
                                            <span class="info-list-title">{{ language_data('Location') }}</span><span
                                                class="info-list-des">{{ $client->address1 }} {{ $client->address2 }}
                                                {{ $client->state }} {{ $client->city }} - {{ $client->postcode }}
                                                {{ $client->country }}</span>
                                        </li>
                                        <li>
                                            <span class="info-list-title">{{ language_data('SMS Balance') }}</span><span
                                                class="info-list-des">{{ $client->sms_limit }}</span>
                                        </li>
                                    </ul>

                                    <a href="#" data-toggle="modal" data-target=".modal_send_sms_{{ $client->id }}"
                                        class="btn btn-success btn-sm"><i class="fa fa-mobile-phone"></i>
                                        {{ language_data('Send SMS') }}</a>
                                    <a href="#" data-toggle="modal"
                                        data-target=".modal_update_limit_{{ $client->id }}"
                                        class="btn btn-primary btn-sm"><i class="fa fa-exchange"></i>
                                        {{ language_data('Update Limit') }}</a>
                                    <a href="#" data-toggle="modal"
                                        data-target=".modal_change_image_{{ $client->id }}"
                                        class="btn btn-complete btn-sm change-image"><i class="fa fa-image"></i>
                                        {{ language_data('Change Image') }}</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#edit-profile" aria-controls="home" role="tab"
                                data-toggle="tab">{{ language_data('Edit Profile') }}</a></li>
                        <li role="presentation"><a href="#tickets" aria-controls="tickets" role="tab"
                                data-toggle="tab">{{ language_data('Support Tickets') }}</a></li>
                        <li role="presentation"><a href="#invoices" aria-controls="invoices" role="tab"
                                data-toggle="tab">{{ language_data('Invoices') }}</a></li>
                        <li role="presentation"><a href="#sms-transaction" aria-controls="sms-transaction" role="tab"
                                data-toggle="tab">{{ language_data('SMS Transaction') }}</a></li>
                    </ul>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="client_group"
                                                data-live-search="true">
                                                <option value="0" @if ($client->groupid == 0) selected @endif>
                                                    {{ language_data('None') }}</option>
                                                @foreach ($clientGroups as $cg)
                                                    <option value="{{ $cg->id }}"
                                                        @if ($client->groupid == $cg->id) selected @endif>
                                                        {{ $cg->group_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="sms_gateway[]"
                                                ...
                                                @if (isset($selected_gateways) && is_array($selected_gateways))
                                                    @foreach ($sms_gateways as $sg)
                                                        <option value="{{ $sg->id }}"
                                                            @if (in_array_r($sg->id, $selected_gateways)) selected @endif>
                                                            {{ $sg->name }}</option>
                                                    @endforeach
                                                @else
                                                    @foreach ($sms_gateways as $sg)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="reseller_panel">
                                                <option value="Yes" @if ($client->reseller == 'Yes') selected @endif>
                                                    {{ language_data('Yes') }}</option>
                                                <option value="No" @if ($client->reseller == 'No') selected @endif>
                                                    {{ language_data('No') }}</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Next Plan recurring date (if you make plan active ensure input next
                                                recurring date)</label>
                                            <input type="date" name="plan_recurring_date"
                                                value="{{ $client->plan_recurring_date }}" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label>Plan Status (If you changed plan, select status. Select Inactive and
                                                create invoice checkbox for user
                                                pay and)</label>
                                            <select name="plan_status" id="plan" class="form-control">
                                                <option value="Inactive"
                                                    {{ $client->plan_status == 'Inactive' ? 'selected' : '' }}>Inactive
                                                </option>
                                                <option value="Active"
                                                    {{ $client->plan_status == 'Active' ? 'selected' : '' }}>Active
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label>{{ language_data('Password') }}</label> <span
                                                class="help">{{ language_data('Leave blank if you do not change') }}</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="api_access">
                                                <option value="Yes" @if ($client->api_access == 'Yes') selected @endif>
                                                    {{ language_data('Yes') }}</option>
                                                <option value="No" @if ($client->api_access == 'No') selected @endif>
                                                    {{ language_data('No') }}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="status">
                                                <option value="Active" @if ($client->status == 'Active') selected @endif>
                                                    {{ language_data('Active') }}</option>
                                                <option value="Inactive"
                                                    @if ($client->status == 'Inactive') selected @endif>
                                                    {{ language_data('Inactive') }}</option>
                                                <option value="Closed" @if ($client->status == 'Closed') selected @endif>
                                                    {{ language_data('Closed') }}</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <div class="coder-checkbox">
                                                <input type="checkbox" value="Yes" name="create_invoice">
                                                <span class="co-check-ui"></span>
                                                <label>Create Invoice (all related Scribble Pro subscription will be
                                                    included)</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="submit" value="{{ language_data('Update') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($in->status == 'Answered')
                                                    <span
                                                        class="label label-success">{{ language_data('Answered') }}</span>
                                                @elseif($in->status == 'Customer Reply')
                                                    <span
                                                        class="label label-info">{{ language_data('Customer Reply') }}</span>
                                                @else
                                            ...
                                            <td class="text-right">
                                                <a href="{{ url('support-tickets/view-ticket/' . $in->id) }}"
                                                    class="btn btn-success btn-xs"><i class="fa fa-eye"></i>
                                                    {{ language_data('View') }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                            ...
                            <table class="table data-table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th span="col">{{ language_data('Amount') }}</th>
                                        <th span="col">{{ language_data('Invoice Date') }}</th>
                                        <th span="col">{{ language_data('Due Date') }}</th>
                                        <th span="col">{{ language_data('Status') }}</th>
                                        <th span="col">{{ language_data('Manage') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($invoices as $in)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($in->status == 'Unpaid')
                                                    <span
                                                        class="label label-warning">{{ language_data('Unpaid') }}</span>
                                                @elseif($in->status == 'Paid')
                                                    <span class="label label-success">{{ language_data('Paid') }}</span>
                                                @elseif($in->status == 'Cancelled')
                                                    <span
                                                        class="label label-danger">{{ language_data('Cancelled') }}</span>
                                                @else
                                                    <span
                                                        class="label label-info">{{ language_data('Partially Paid') }}</span>
                                                @endif
                                            </td>
                                            <td>
                                                <a href="{{ url('invoices/view/' . $in->id) }}"
                                                    class="btn btn-success btn-xs m-b-10"><i class="fa fa-eye"></i>
                                                    {{ language_data('View') }}</a>
                                                <a href="{{ url('invoices/edit/' . $in->id) }}"
                                                    class="btn btn-primary btn-xs m-b-10"><i class="fa fa-edit"></i>
                                                    {{ language_data('Edit') }}</a>
                                                <a href="#" class="btn btn-danger btn-xs cdelete "
                                                    id="{{ $in->id }}"><i class="fa fa-trash"></i>
                                                    Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
    ...
    <div class="modal fade modal_send_sms_{{ $client->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-some-up form-block" role="form" action="{{ url('clients/send-sms') }}"
                    method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <span class="help text-uppercase" id="remaining">160
                                {{ language_data('characters remaining') }}</span>
    ...
    <div class="modal fade modal_update_limit_{{ $client->id }}" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="form-some-up form-block" role="form" action="{{ url('clients/update-limit') }}"
                    method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <span
                                class="help">{{ language_data('Update with previous balance. Enter (-) amount for decrease limit') }}</span>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
    ...
    <div class="modal fade modal_change_image_{{ $client->id }}" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="form-some-up form-block" role="form" action="{{ url('clients/update-image') }}"
