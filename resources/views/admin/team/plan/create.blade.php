...
@section('content')
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">Add Team Link Pricing</h2>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Add Team link Pricing</h3>
                        </div>
                        <div class="panel-body">
                            <form class="" method="post" action="/team/plan">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Type of Plan (each plan will have one pro plan)</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Price/per Team member</label>
                                            <input type="text" class="form-control" name="price" required>
                                        </div>

                                        <div class="form-group">
                                            <label>{{ language_data('TRANSACTION FEE') }} (%)</label>
                                            <input type="text" class="form-control" value="0" name="transaction_fee"
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group" style="margin-top: 45px;">
                                            ...
                                            <input value="16" type="text" class="form-control"
                                                name="govt_charges_amount" required>
                                        </div>
                                        <div class="form-group" style="margin-top: 45px;">
