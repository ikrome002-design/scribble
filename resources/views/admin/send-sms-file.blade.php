                            ...
                            <div id="send-sms-file-wrapper">
                                <form id="send-sms-file-form" class="" role="form" method="post"
                                            ...
                                            <span class="input-group-btn">
                                                <span class="btn btn-primary btn-file">
                                                    {{ language_data('Browse') }} <input type="file" class="form-control"
                                                        name="import_numbers" @change="handleImportNumbers">
                                                </span>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" name="country_code"
                                            ...
                                            <option value="0" @if (app_config('send_sms_country_code') == 0) selected @endif>
                                                {{ language_data('Exist on phone number') }}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span
                                            class="help">{{ language_data('Only work with two way sms gateway provider') }}</span>
                                        <select class="selectpicker form-control" name="keyword[]" data-live-search="true"
                                            multiple>
                                    ...
                                    <div class="schedule_time">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control schedule_time_type"
                                                ...
                                                <option value="from_date">{{ language_data('Schedule Time Using Date') }}
                                                </option>
                                                <option value="from_file">{{ language_data('Schedule Time Using File') }}
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group from_date">
                                            ...
                                            <input type="text" class="form-control dateTimePicker"
                                                name="schedule_time"
                                                value="{{ date('m/d/y H:i y', strtotime('2 minute')) }}">
                                            <span
                                                class="help text-danger text-uppercase">{{ language_data('Schedule Time must contain this format') }}
                                        ...
                                        <div class="form-group from_file"
                                            ...
                                            <label>{{ language_data('Schedule Time') }}
                                    ...
                                    <span
                                        class="text-uppercase text-complete help">{{ language_data('After click on Send button, do not refresh your browser') }}</span>

                                    <button type="submit" id="submitContact"
                                        class="btn btn-success btn-sm pull-right"><i class="fa fa-send"></i>
                                        {{ language_data('Send') }} </button>
