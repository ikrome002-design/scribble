                ...
                <div class="col-lg-4">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <ul class="info-list">
                                <li>
                                    <span class="info-list-title">{{ language_data('Export Clients') }}</span><span
                                        class="info-list-des"><a href="{{ url('clients/export-clients') }}"
                                            class="btn btn-success btn-xs">{{ language_data('Export Clients as CSV') }}</a></span>
                                </li>
                                <li>
                                    <span class="info-list-title">{{ language_data('Sample File') }}</span><span
                                        class="info-list-des"><a href="{{ url('clients/download-sample-csv') }}"
                                            class="btn btn-complete btn-xs">{{ language_data('Download Sample File') }}</a>
                                    </span>
                                </li>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div id="import-clients">
                                <form id="import-client-from-file" role="form" method="post"
                                    action="{{ url('clients/post-new-client-csv') }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            ...
                                            <span class="input-group-btn">
                                                <span class="btn btn-primary btn-file">
                                                    {{ language_data('Browse') }} <input type="file"
                                                        class="form-control" name="import_client"
                                                        @change="handleImportClients">
                                                </span>
                                            </span>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="first_name_column"
                                            name="first_name_column" data-live-search="true" v-model="first_name_column">
                                            <option v-for="column in client_columns" :value="column.key"
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="last_name_column"
                                            name="last_name_column" data-live-search="true">
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="company_column" name="company_column"
                                            data-live-search="true">
                                            <option :value="0"></option>
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="website_column"
                                            name="website_column" data-live-search="true">
                                            <option :value="0"></option>
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                        </select>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="user_name_column"
                                            name="user_name_column" data-live-search="true" v-model="user_name_column">
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <span class="help">Required</span>
                                        <select class="selectpicker form-control" ref="password_column"
                                            name="password_column" data-live-search="true" v-model="password_column">
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="address_column"
                                            name="address_column" data-live-search="true">
                                            <option :value="0"></option>
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                        </select>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="more_address_column"
                                            name="more_address_column" data-live-search="true">
                                            <option :value="0"></option>
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                        </select>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="state_column" name="state_column"
                                            data-live-search="true">
                                            <option :value="0"></option>
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="city_column" name="city_column"
                                            data-live-search="true">
                                            <option :value="0"></option>
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="postcode_column"
                                            name="postcode_column" data-live-search="true">
                                            <option :value="0"></option>
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                        </select>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <span class="help">Required</span>
                                        <select class="selectpicker form-control" ref="country_column"
                                            name="country_column" data-live-search="true" v-model="country_column">
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" v-show="client_columns.length > 0">
                                        ...
                                        <span class="help">Required</span>
                                        <select class="selectpicker form-control" ref="sms_limit_column"
                                            name="sms_limit_column" data-live-search="true" v-model="sms_limit_column">
                                            <option v-for="column in client_columns" :value="column.key"
                                                v-text="column.value"></option>
                                        </select>
                                    </div>
                                    ...
                                    <br>
                                    <p class="text-uppercase text-complete help">
                                        {{ language_data('It will take few minutes. Please do not reload the page') }}</p>
                                    <button type="submit" class="btn btn-success btn-sm pull-right"><i
                                            class="fa fa-download"></i> {{ language_data('Import') }} </button>
                                </form>
                            </div>
                        </div>
                    </div>
