                            ...
                            <div class="clearfix">
                                ...
                                <div class="pull-left">
                                    ...
                                    <ul class="info-list">
                                        @if ($client->email != '')
                                            <li><span
                                                    class="info-list-title">{{ language_data('Email', Auth::guard('client')->user()->lan_id) }}</span><span
                                                    class="info-list-des">{{ $client->email }}</span></li>
                                        @endif

                                        @if ($client->username != '')
                                            <li><span
                                                    class="info-list-title">{{ language_data('User Name', Auth::guard('client')->user()->lan_id) }}</span><span
                                                    class="info-list-des">{{ $client->username }}</span></li>
                                        @endif

                                        <li>
                                            <span
                                                class="info-list-title">{{ language_data('SMS Balance', Auth::guard('client')->user()->lan_id) }}</span><span
                                                class="info-list-des">
                                                {{ $client->sms_limit }}
                                            </span>
                                        </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#personal_details" aria-controls="home"
                                role="tab"
                                data-toggle="tab">{{ language_data('Personal Details', Auth::guard('client')->user()->lan_id) }}</a>
                        </li>

                        <li role="presentation"><a href="#change-picture" aria-controls="settings" role="tab"
                                data-toggle="tab">{{ language_data('Change Image', Auth::guard('client')->user()->lan_id) }}</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content panel p-20">
                            ...
                            <form role="form" action="{{ url('user/post-personal-info') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="Country">{{ language_data('Country', Auth::guard('client')->user()->lan_id) }}</label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="submit"
                                            value="{{ language_data('Update', Auth::guard('client')->user()->lan_id) }}"
                        ...
                        <div role="tabpanel" class="tab-pane" id="change-picture">
                            <form role="form" action="{{ url('user/update-avatar') }}" method="post"
