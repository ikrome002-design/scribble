                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="btn-group pull-right" aria-label="...">
                                <form method="post" action="/user/invoice/mass-generate">
                                    {{ csrf_field() }}
                                    <button class="btn btn-success btn-xs pay-invoice"><i class="fa fa-check"></i>View & Pay
                                        for all unpaid invoices not due</i>
                                    </button>
                                </form>
                            </div>
