                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                {{ language_data('Send Bulk SMS', Auth::guard('client')->user()->lan_id) }}</h3>
                        </div>
                                ...
                                <form id="send-sms-file-form" class="" role="form" method="post"
                                    ...
                                    @if (app_config('show_keyword_in_client') == 1)
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="keyword[]"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control message_type" name="message_type">
                                            ...
                                            <option value="arabic">
                                                {{ language_data('Arabic', Auth::guard('client')->user()->lan_id) }}
                                            </option>
                                            <option value="voice">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="help text-success" id="messages">1
                                            {{ language_data('message', Auth::guard('client')->user()->lan_id) }}
                                            (s)</span>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="coder-checkbox">
                                            <input type="checkbox" name="send_later"
                                                @if ($schedule_sms) checked @endif class="send_later"
                                                value="on">
                                            <span class="co-check-ui"></span>
                                    ...
                                    <div class="schedule_time">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control schedule_time_type"
                                                ...
                                                <option value="from_date">
                                                    {{ language_data('Schedule Time Using Date', Auth::guard('client')->user()->lan_id) }}
                                                </option>
                                                <option value="from_file">
                                                    {{ language_data('Schedule Time Using File', Auth::guard('client')->user()->lan_id) }}
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group from_date">
                                            ...
                                            <input type="text" class="form-control dateTimePicker"
                                                name="schedule_time">
                                            <span
                                                class="help text-danger text-uppercase">{{ language_data('Schedule Time must contain this format', Auth::guard('client')->user()->lan_id) }}
                                        ...
                                        <div class="form-group from_file"
                                            ...
                                            <label>{{ language_data('Schedule Time', Auth::guard('client')->user()->lan_id) }}
                                                {{ language_data('Column', Auth::guard('client')->user()->lan_id) }}</label>
                                    ...
                                    <button type="submit" id="submitContact" class="btn btn-success btn-sm pull-right">
                                        ...
                                        {{ language_data('Send', Auth::guard('client')->user()->lan_id) }}
                                    </button>
