...
//packages and accounts admin
Route::get('test', 'TestController@test');
Route::post('/user/generate/otp', 'OtpController@client');
Route::post('/staff/generate/otp', 'OtpController@staff');
Route::post('/admin/generate/otp', 'OtpController@admin');

//seach 
Route::middleware('admin')->group(function () {
    Route::get('admin/client/search', 'SearchController@client');
});
...
//mpesa callback
Route::post('/vendor/py/validation.php', 'MpesaResponseController@validation');
Route::post('/vendor/py/confirmation.php', 'MpesaResponseController@confirmation');
Route::post('/daraja/stk/callback', 'MpesaResponseController@stkCallback');
Route::post('/daraja/timeout', 'MpesaResponseController@timeout');



//packages and accounts admin
Route::get('admin/packages', 'PackageAccountsController@viewPackages');
Route::match(['get', 'post'], 'admin/package/add', 'PackageAccountsController@addPackage');
Route::match(['get', 'post'], 'admin/package/edit/{id}', 'PackageAccountsController@editPackage');
Route::match(['get', 'post'], 'admin/package/features/{id}', 'PackageAccountsController@editFeatures');
Route::get('admin/package/delete/{id}', 'PackageAccountsController@deletePackage');
Route::get('admin/accounts', 'PackageAccountsController@viewAccounts');
Route::match(['get', 'post'], 'admin/account/add', 'PackageAccountsController@addAccount');
Route::match(['get', 'post'], 'admin/account/edit/{id}', 'PackageAccountsController@editAccount');
Route::get('admin/account/delete/{id}', 'PackageAccountsController@deleteAccount');


//packages and accounts client
Route::get('user/package/all', 'ClientPackageAccountsController@viewPackages');
Route::get('user/package/features/{id}', 'ClientPackageAccountsController@ViewFeatures');
Route::get('user/package/change/{id}', 'ClientPackageAccountsController@changePackage');
Route::get('user/accounts/all', 'ClientPackageAccountsController@viewAccounts');
Route::get('/user/account/change/{id}', 'ClientPackageAccountsController@changeAccount');


// Route::get('/test', 'TestController@handle');
//mpesa
// Route::get('/stk/push/simulation', 'MpesaController@stkSimulation');
// Route::get('/stk/push/status', 'MpesaController@stkPushStatusQuery');
// Route::get('/mpesa/trans-status', 'MpesaController@tranStatus');
// Route::get('/mpesa/payment-request', 'MpesaController@c2bPaymentRequest');

//======================================================================
// Client Login
//======================================================================

Route::get('industry', 'DefaultController@industry');
Route::post('user/add-industry', 'DefaultController@addIndustry');
Route::get('/register', 'AuthController@register');
Route::post('/store-stpes', 'AuthController@storeSteps')->name('steps');

// Route::get('/storage/invoice/{$invoice_no}', 'FileController@invoice');
// Route::get('/storage/receipt/{$invoice_no}', 'FileController@receipt');
// Route::get('/storage/admin-profile/{$id}', 'FileController@admin');
Route::get('/private/profile/client/{id}/{filename}', 'FileController@clientProfileImage');

Route::get('/private/profile/admin/{filename}', 'FileController@adminProfileImage');
// senderId
Route::get('/private/senderid/{filename}', 'FileController@senderId');
Route::post('/send-senderid-government/{sender_id}', 'SMSController@sendSenderIdGovernment');

Route::get('/private/visitor/{filename}', 'FileController@visitorImage');

Route::get('/private/staff/{filename}', 'FileController@staffImage');

//mass view unpaid invoices;
Route::post('/user/invoice/mass-generate', 'ClientInvoiceController@generateUpaidInvoices');
Route::get('/user/invoices/mass/{mass_invoice_no}', 'ClientInvoiceController@unpaidInvoices');
Route::get('user/invoices/mass-download-pdf/{id}', 'ClientInvoiceController@massDownloadPdf');

//receipts
Route::get('/user/receipts/all', 'ClientReceiptController@allReceipts');
Route::get('/user/receipts/view/{receipt_no}', 'ClientReceiptController@viewReceipt');
Route::get('/user/receipts/download-pdf/{receipt_no}', 'ClientReceiptController@downloadPdf');

//receipts admin
Route::get('/receipts/all', 'ReceiptController@allReceipts');
Route::get('/receipts/view/{id}', 'ReceiptController@viewReceipt');
Route::get('/receipts/delete/{id}', 'ReceiptController@deleteReceipt');
Route::get('/receipts/download-pdf/{id}', 'ReceiptController@downloadPdf');

//payments confirmation
Route::post('/invoice/pay-single/{invoice_no}', 'PaymentInvoiceController@singleInvoicePayment');
Route::post('/invoice/pay-mass/{mass_invoice_no}', 'PaymentInvoiceController@massInvoicePayment');
Route::post('/invoice/complete/{invoice_no}', 'PaymentInvoiceController@checkInvoicePayment');

//new price plan 
Route::get('user/price-plans/all', 'ClientPLanController@allPricePlans');
Route::get('user/view/plan/{id}', 'ClientPLanController@viewPlan');
Route::get('user/plan/change/{id}', 'ClientPLanController@changePlan');

// //nw airtime bundle
// Route::get('user/airtime-bundles/all', 'ClientPLanController@AllAirtimeBundles');
// Route::get('user/airtime-bundle/buy/{id}', 'ClientPLanController@buyAirtimeBundle');
...
Route::get('/register', 'AuthController@register');
Route::post('/store-stpes', 'AuthController@storeSteps')->name('steps');
Route::get('/register/invoice/{id}', 'AuthController@registerInvoice')->name('register-invoice');

//for accounts
Route::match(['get', 'post'], 'admin/plan-features/edit/{id}', 'PlanAccountsController@editPlan');
Route::get('admin/accounts', 'PlanAccountsController@viewAccounts');
Route::match(['get', 'post'], 'admin/account/add', 'PlanAccountsController@addAccount');
Route::match(['get', 'post'], 'admin/account/edit/{id}', 'PlanAccountsController@editAccount');
Route::get('admin/account/delete/{id}', 'PlanAccountsController@deleteAccount');

Route::get('/login', 'AuthController@clientLogin')->name('login');
...
Route::get('sms/plan', 'SMSController@plans');
Route::get('sms/add-plan-name', 'SMSController@addPlanName');
Route::get('sms/delete-plan/{id}', 'SMSController@deletePlan');
Route::post('sms/post-new-plan-name', 'SMSController@postNewPlanName');
...
Route::get('sms/delete-price-plan/{id}', 'SMSController@deletePricePlan')->name('delete_plan');

Route::get('sms/edit-sms-price-plan/{id}', 'SMSController@editPlan');
Route::post('sms/update-price-plan/{id}', 'SMSController@updatePlan');
Route::get('sms/view-sms-price-plan/{id}', 'SMSController@viewPlan');
Route::get('sms/delete-sms-price-plan/{id}', 'SMSController@deleteSmsPlan');


Route::get('sms/airtime-bundle', 'SMSController@airtimeBundle');
Route::get('sms/show-airtime-bundle/{id}', 'SMSController@view');
Route::get('sms/add-airtime-bundle', 'SMSController@addAirtimeBundle');
Route::post('sms/post-new-airtime-bundle', 'SMSController@postAirtime');
Route::get('sms/edit-airtime-bundle/{id}', 'SMSController@editAirtime');
Route::post('sms/update-airtime-bundle/{id}', 'SMSController@updateAirtime');
Route::get('sms/delete-airtime-bundle/{id}', 'SMSController@deleteAirtime');
...
// check the range of buy unit
Route::post('user/sms/unit-range', 'UserSMSController@buyRange')->name('unit-range');
...
// Purchase SMS Plan
//======================================================================
Route::match(['get', 'post'], 'user/sms/purchase-sms-plan', 'UserSMSController@allSmsPricePlan');
Route::match(['get', 'post'], '/user/sms/view-sms-price-plan/{id}', 'UserSMSController@viewSmsPricePlan');
Route::get("/user/sms/sms-price-plan/calculate", 'UserSMSController@smsPricePlanCalc');
...
Route::get('user/sms/purchase-airtime-bundle', 'UserSMSController@PurchaseAirtimeBundle');
Route::match(['get', 'post'], 'user/sms/view-airtime-bundle/{id}', 'UserSMSController@viewAirtimeBundle');
Route::get('user/sms/airtime-bundle/calculate', 'UserSMSController@artimeBundleCalc');
Route::get('user/sms/view-price-plan/{id}', 'UserSMSController@viewPricePlan');
