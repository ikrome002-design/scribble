...
Route::post('/invoice/pay/stk/{invoice_no}', 'PaymentInvoiceController@stkInvoicePayment');
...
Route::post('user/package/change/renew/{id}', 'ClientPackageAccountsController@changeRenewPackage');
...
Route::get('/user/invoices/mass/{mass_invoice_no}', 'ClientInvoiceController@massInvoices');
...
Route::get('/', 'ClientDashboardController@dashboard');
...
Route::middleware('clientMainSubscription')->group(function () {
    ...
    Route::namespace('Team')->prefix('team')->group(function () {
        ...
        Route::resource('plan', 'PlanController')->names([
            'index' => 'team.users.team.plan.index',
            'create' => 'team.users.team.plan.create',
            'store' => 'team.users.team.plan.store',
            'show' => 'team.users.team.plan.show',
            'edit' => 'team.users.team.plan.edit',
            'update' => 'team.users.team.plan.update',
            'destroy' => 'team.users.team.plan.destroy',
        ]);

        Route::post('subscription/generate/invoice/{id}', 'SubscriptionController@generateInvoice');
        Route::post('subscription/opt/out/{id}', 'SubscriptionController@optOut');
        Route::post('subscription/opt/in/{id}', 'SubscriptionController@optIn');
        Route::post('subscription/memebers/scale/{id}', 'SubscriptionController@scaleUpDown');
        Route::post('subscription/stop/action/{id}', 'SubscriptionController@stopTeamMembersAction');
        Route::resource('subscription', 'SubscriptionController')->names([
            'index' => 'team.users.team.subscription.index',
            'create' => 'team.users.team.subscription.create',
            'store' => 'team.users.team.subscription.store',
            'show' => 'team.users.team.subscription.show',
            'edit' => 'team.users.team.subscription.edit',
            'update' => 'team.users.team.subscription.update',
            'destroy' => 'team.users.team.subscription.destroy',
        ]);
        Route::resource('members', 'MembersController')->names([
            'index' => 'team.users.team.members.index',
            'create' => 'team.users.team.members.create',
            'store' => 'team.users.team.members.store',
            'show' => 'team.users.team.members.show',
            'edit' => 'team.users.team.members.edit',
            'update' => 'team.users.team.members.update',
            'destroy' => 'team.users.team.members.destroy',
        ]);
    });
    //======================================================================
    // SMS History
...
*/
    ...
    Route::get('sms/delete-price-plan/{id}', 'SMSController@deletePricePlan')->name('team.delete_plan');
...
*/
    ...
    Route::post('user/sms/unit-range', 'UserSMSController@buyRange')->name('team.unit-range');
