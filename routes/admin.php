...
Route::post('/store-stpes', 'AuthController@storeSteps');
...
Route::get('/register', 'AuthController@register');
Route::post('/store-stpes', 'AuthController@storeSteps');
Route::get('/register/invoice/{id}', 'AuthController@registerInvoice');
...
Route::post('user/sms/unit-range', 'UserSMSController@buyRange');
